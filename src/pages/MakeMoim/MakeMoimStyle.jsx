...
const Textarea = styled.textarea`
  /* 나머지 textarea에 대한 스타일 추가 */
`;

const JujaeArea = styled.div`
  /* 나머지 JujaeArea에 대한 스타일 추가 */
`;

const JujaeBtn = styled.div`
  /* 나머지 JujaeBtn에 대한 스타일 추가 */
`;

const ImgArea = styled.div`
  /* 나머지 ImgArea에 대한 스타일 추가 */
`;
...
const NavOrangeText = styled.div`
  position: relative;
...
export const MakeMoim = styled.div`
.titleArea {
  width: 100%;
  height: 56px;
  position: relative;
