...
const MeetingChat = () => {
    ...
    useEffect(() => {
        ...
        setDate(`${currentDate.getFullYear()}년 ${currentDate.getMonth() + 1}월 ${currentDate.getDate()}일`);
    }, []);
      ...
      <styles.MeetingChatBody>
        ...
        <div className="background">
            ...
            <div className="titleBox">
                ...
                <div className="selTitle"><Link to="/MeetingDetails/MeetingChat">단체톡</Link></div>
                <div className="title"><Link to="/MeetingDetails/MeetingItems">용품구매</Link></div>
                    </div>
                    {/* 세부 항목들 */}
                    <div className="chatday" id="chatday">{date}</div>
