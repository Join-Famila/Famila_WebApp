    ...
    return (
        <styles.MeetingDetailsHomeBody>
            ...
            <div className="titleBox">
                <div className="selTitle"><Link to="/MeetingDetails/MeetingDetailsHome">홈</Link></div>
                <div className="title"><Link to="/MeetingDetails/MeetingPost">게시판</Link></div>
                <div className="title"><Link to="/MeetingDetails/MeetingPhoto">사진첩</Link></div>
                <div className="title"><Link to="/MeetingDetails/MeetingChat">단체톡</Link></div>
                <div className="title"><Link to="/MeetingDetails/MeetingItems">용품구매</Link></div>
      </div>
            ...
            <styles.MeetingSchedule>
                <p style={{ fontSize: "20px" }}>모임 일정 <span style={{ fontSize: "20px" }}>{myMeetingSchedule}</span></p>
            ...
            <div className="myMoim" style={{ marginTop: "32px" }}>
                사진첩
                <div className="viewAll" onClick={goToImgs}>전체 보기</div>
            </div>
            <div className="moimSaJinArea">
                <div className="moimSaJin" style={{ backgroundImage: `url(${imgA})` }}></div>
                <div className="moimSaJin" style={{ backgroundImage: `url(${imgA})` }}></div>
                <div className="moimSaJin" style={{ backgroundImage: `url(${imgA})` }} onClick={goToImgs}>+9</div>
            </div>
            ...
            {isMeetingOrder ?
                <>
                    <div className="make1jung">
                        <div className="make1Text" onClick={createMeeting}>일정 생성</div>
                    </div>
                    <div className="invite">
                        <div className="inviteText" onClick={() => alert("준비중입니다")}>+ 친구 초대</div>
                    </div>
                </> :
                <></>
            }
